...
/**
 *
  * class_name: StringRedisTokenStore
  * describe: do
 ...
 **/
@Component
public class StringRedisTokenStore implements TokenStore {
    ...
    public StringRedisTokenStore(RedisConnectionFactory connectionFactory) {
